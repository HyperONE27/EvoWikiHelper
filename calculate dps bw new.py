...
class DPSCalculator:
    ...
    def __init__(self, unit_name: str, base_damage: float, upgrade_damage: float,
                 cooldown: float, damage_type: DamageType, attacks: int = 1):
        """
...
def calculate_dps_bw(unit_name: str, base: float, upgrade: float, 
                     cooldown: float, dmg_type: int, attacks: int, 
                     display_mode: int = 1) -> None:
    """
